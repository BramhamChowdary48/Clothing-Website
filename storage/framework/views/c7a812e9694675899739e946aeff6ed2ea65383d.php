            ...
            <div class="product-item">
              ...
              <div class="down-content">
                ...
                <form action="<?php echo e(url('addcart',$product->id)); ?>" method="POST">
                  ...
                  <input style="background-color: blue;" class="btn btn-primary" type="submit" value="Add Cart">
...
<?php /**PATH C:\xampp\htdocs\ClothKit\resources\views/user/product.blade.php ENDPATH**/ ?>