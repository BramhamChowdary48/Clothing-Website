...
<div style="padding: 100px;" align="center">
    ...
    <table>
        <tr style="background-color: gray;">
            <td style="padding: 10px; font-size: 20px; color:aliceblue;">Product Name</td>
            <td style="padding: 10px; font-size: 20px; color:aliceblue;">Quantity</td>
            <td style="padding: 10px; font-size: 20px; color:aliceblue;">Price</td>
            <td style="padding: 10px; font-size: 20px; color:aliceblue;">Action</td>
        </tr>
...
<form action="<?php echo e(url('order')); ?>" method="POST">
    ...
    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr style="background-color: black;">
            <td style="padding: 10px; color:aliceblue;">
...
<?php /**PATH C:\xampp\htdocs\ClothKit\resources\views/user/showcart.blade.php ENDPATH**/ ?>